...
- `README*`, `AGENTS.md`, `CLAUDE.md` — layout, feature lists
- `docs/*.md` — architecture, pipeline diagrams, terminology
- Any doc with a file tree, module list, or "not yet implemented" marker
...
| Symbol / export name | Does it match the actual source? |
